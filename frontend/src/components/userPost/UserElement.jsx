...
const UserElement = ({ele, handleLikeDecre, handleDeletePost, handleLikeIncre}) => {
                      ...
                      <div class="card shadow-sm">
                         <div style={{padding: "2%"}}>
                           ...
                           <img src={ele.photo} height="250px"/>
                            ...
                            <button type="button" className="btn btn-outline-danger" onClick={() =>handleDeletePost(ele._id)}>Delete</button>
                        </div>
